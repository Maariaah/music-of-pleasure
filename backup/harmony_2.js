...
let harmony2Chords = [];
let IChord2, IIChord2, IIIChord2, IVChord2, VChord2, VIChord2;

function initializeHarmony2() {
  // Define chords
  IChord2 = constructMajorChord(Cmajor, 3, "F2");
  IIChord2 = constructMajorChord(Cmajor, 4, "A2");
  IIIChord2 = constructMajorChord(Cmajor, 4, "E3");
  IVChord2 = constructMajorChord(Cmajor, 4, "C4");
  VChord2 = constructMajorChord(Cmajor, 4, "A3");
